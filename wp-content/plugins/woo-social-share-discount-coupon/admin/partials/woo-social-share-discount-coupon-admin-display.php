	...
	public static function wssdc_general_setting() {
		...
		if (isset($_POST['wssdc_intigration'])):
            ...
            <div id="setting-error-settings_updated" class="updated settings-error"> 
                <p><?php echo '<strong>' . __('Settings were saved successfully.', 'woo-social-share-discount-coupon') . '</strong>'; ?></p></div>
		...
		if (!get_option('wssdc_plugin_notice_shown')) {
   			 echo '<div id="wssdc_dialog" title="Basic dialog"> <p> Subscribe for latest plugin update and get notified when we update our plugin and launch new products for free! </p> <p><input type="text" id="txt_user_sub_wssdc" class="regular-text" name="txt_user_sub_wssdc" value="'.$current_user->user_email.'"></p></div>';
