...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-129329575-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
 
  gtag('config', 'UA-129329575-1');
</script>
...
<meta property="og:description" content="We create sales video’s to boost your conversion rate and upgrade your website traffic!"/>
</head>
